...
def home():
    ...
    chk_relation = Liked.query.filter_by(
        user_id=user_id, quote_id=id_to_display).first() is not None
...
def register():
    ...
    username_exists = User.query.filter_by(
        username=new_username).first() is not None
...
def like():
    ...
    chk_relation = Liked.query.filter_by(
        user_id=user_id, quote_id=quote_id).first() is not None
